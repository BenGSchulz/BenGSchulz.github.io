  ...
  return (
    <div className="flex flex-col pt-4 gap-2">
      {paragraphs.map((paragraph) => (
        <p key={paragraph.id} className="px-2 py-1">
          {paragraph.text}
        </p>
      ))}
